...
const submitForm = (event) => {
  ...
  axios.post('https://ds-hardwood-flooring-server.herokuapp.com/contacts/add_contact', {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <main className="overflow-hidden">
        ...
        {/* Header */}
        <div className="pb-16 pt-16 bg-construction bg-cover bg-center bg-no-repeat">
          <div className="py-24 lg:py-32 ">
            <div className="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
              <h1 className="text-4xl font-extrabold tracking-tight text-white mt-40 sm:text-5xl lg:text-6xl">
                Get in touch
              </h1>
            </div>
          </div>
        ...
        {/* Contact section */}
        <section className="relative bg-gray-200 " aria-labelledby="contact-heading">
          <div className="pt-2 bg-gray-300 "></div>
        
                
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="pt-12"></div>
            <div className="rounded-2xl shadow-2xl relative bg-white">
              <div className="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div className="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-teal-500 to-teal-600 sm:px-10 xl:p-12">
                  ...
                  <dl className="mt-8 space-y-6">
                    ...
                    <dd className="flex text-base text-teal-50" >
                      ...
                      <span className="ml-3">daniel@dshardwoodflooring.com</span>
                    </dd>
                  </dl>
                  <ul className="mt-8 flex space-x-12" role="list">
                    ...
                    <li>
                      <a className="text-teal-200 hover:text-teal-100" href="https://www.instagram.com/ds_hardwood_flooring/">
                ...
                {/* <form id="quoteForm" onSubmit={submitForm} method="POST" className="grid grid-cols-2 gap-4 mt-6 gap-y-6"> */}
                  <form id="contactForm" method="POST" onSubmit={submitForm} className="mt-6 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                    <div>
        ...
        <section aria-labelledby="offices-heading">
          <div className="max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            ...
            <p className="mt-6 text-lg  text-warm-gray-500 max-w-3x3">
