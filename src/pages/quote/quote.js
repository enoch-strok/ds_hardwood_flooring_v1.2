...
import ComponentQuote from '../about/sections/Intro/components/ComponentQuote'
...
const Quote = props => {
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="pb-16 pt-16 bg-construction2 bg-cover bg-center bg-no-repeat">
        ...
        <section className="relative bg-gray-300" aria-labelledby="contact-heading">
